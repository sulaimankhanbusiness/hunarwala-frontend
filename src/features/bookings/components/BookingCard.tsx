...
export const BookingCard = ({ booking, role, onUpdate }: BookingCardProps) => {
    console.log(`[BookingCard] Rendering ID: ${booking.id}, Role: ${role}, Status: ${booking.status}`);
            ...
            <div className="p-4 space-y-3">
                ...
                <div className="flex items-center justify-between pt-1">
                    <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-sm font-black text-gray-900">Rs. {booking.estimatedPrice}</span>
                    </div>
                </div>
                    ...
                    <div className="p-4 bg-gradient-to-br from-blue-50 to-indigo-50/30 rounded-2xl border border-blue-100/50 mt-4 animate-in zoom-in-95 duration-300">
                        ...
                        <div className="flex justify-between items-center pt-1">
                            ...
                            <span className="text-lg font-black text-blue-700">
                                Rs. {Number(booking.agreedAmount) || Number(booking.helperReportedAmount) || 0}
                            </span>
                        </div>
                    </div>
                )}
