      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-1">
            <Link href="/" className="text-2xl font-bold text-indigo-600 tracking-tighter mb-4 block">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-600">
              <li><Link href="/services" className="hover:text-indigo-600 transition-colors">Find a Service</Link></li>
              ...
              <li><Link href="/trust" className="hover:text-indigo-600 transition-colors">Trust & Safety</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-600">
              <li><Link href="/register" className="hover:text-indigo-600 transition-colors">Join as a Professional</Link></li>
